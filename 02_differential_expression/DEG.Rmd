...
- low counts per gene, which can result in artificially inflated log2-fold change values


```{r setup_RUV}
# IF NECESSARY: filter out lowly-expressed genes
# zero_dist <- rowSums(counts > 0)
# hist(zero_dist) # look at this distribution to figure out an appropriate cutoff for the line below
# counts <- counts[which(zero_dist >= 9), ]
